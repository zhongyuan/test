            ...
            <div class="ff">
                ...
                <?php }else{?>
                    <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1920" height="470">
                        <param name="movie" value="<?php echo $this->staticUrl('index/index_banner_01.swf');?>" />
                        ...
                        <?php $agent = $_SERVER["HTTP_USER_AGENT"]; if(!strpos($agent,"MSIE")){?>
                            <object type="application/x-shockwave-flash" data="<?php echo $this->staticUrl('index/index_banner_01.swf');?>" width="1920" height="470">
                            <!--<![endif]-->
                            <param name="quality" value="high" />
                            <param name="wmode" value="opaque" />
                            <param name="swfversion" value="15.0.0.0" />
