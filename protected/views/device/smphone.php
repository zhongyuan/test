...
<div class="dd">
	<div class="mm">
		<div class="ff"><img src="<?php echo $this->staticUrl('device/phone/device_phone_banner1.jpg');?>"/></div>
	</div>
</div>
		...
		<ul class="d_phonelist">
			<li class="stick_bottom">
				<div class="img_right">
					<div class="phone_two">
						...
						<p><img src="<?php echo $this->staticUrl('device/phone/device_phone_banner2_character.jpg');?>"/></p>
					</div>
			...
			<li class="above_bottom">
				...
				<div class="phone_three">
					...
					<p><img src="<?php echo $this->staticUrl('device/phone/device_phone_banner3_character.jpg');?>"/></p>
				</div>
			</li>
			<li class="stick_bottom">
				<div class="img_right">
					<div class="phone_four">
						...
						<p><img src="<?php echo $this->staticUrl('device/phone/device_phone_banner4_character.jpg');?>"/></p>
					</div>
				</div>
