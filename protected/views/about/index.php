...
<div class="aboutIbg">
    ...
    <div class="about_row" style="margin-top:30px;">
        ...
        <div class="about_rowblock2">
            ...
            Operation System（简称COS）。COS为中国的手机、PAD、机顶盒、PC、智能家电等提供操作系统层面的支持，同时为中国用户提供更优秀的使用体验。</div><br/>
            
            <div class="text_indent">COS提供以应用商店、会员平台、支付平台、广告平台为核心的功能模块，上游支持并服务运营商产品及盈利模式，下游向生产商提供以COS为核心的整体解决方案，最终形成产业链，打造合作伙伴共同获益的生态系统。</div><br/>
