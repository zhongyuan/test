...
<div class="footer" >
    <div class="left" style="width: 350px;">
        ...
        <p class="font_11"><?php echo Yii::t('main','visite_cos_store');?>,<br/><?php echo Yii::t('main','retail_cos_store');?></p>
    </div>

    <div class="left" style="width: 100px;padding: 0px 20px 0px 200px;">

        <ul class="vertical">
            <li><span class="font_10"><?php echo Yii::t('main','relative_info');?></span></li>
    ...
    <div class="left">
        <ul class="vertical" >
            <li><span class="font_10"><?php echo Yii::t('main','support');?></span></li>
    ...
    <div class="left" style="padding-left: 70px;">
        <ul class="vertical" >
            <li><span class="font_10"><?php echo Yii::t('main','search');?></span></li>
