...
class MCNews {
    ...
    {
        $title = '9COS发布会在京召开，各路豪杰相聚发布会，赞叹系统完美至极！';
        $outline = '9在HTC 201顶顶顶顶顶顶顶反反复复在HTC 2012年的年会上，HTC CEO周顶反反复复在HTC 2012年的年会上，HTC CEO永明展示了一款神秘的手机。这款手机大家纷纷猜测可能看看看 看看看看看库顶顶顶顶顶顶顶顶短短的顶顶顶顶顶顶顶顶顶顶。顶顶顶顶短短的9。';
        $img_little = 1;
        $time = time();
